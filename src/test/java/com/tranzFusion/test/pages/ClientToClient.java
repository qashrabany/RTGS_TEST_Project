...
public class ClientToClient extends BasePage {
    ...
    public ClientToClient fillCustomerAccountNo(int account){
        Actions actions = new Actions(driver);
        ...
        getWebElement(By.cssSelector("#contPlcHdrMasterHolder_TFtxtCustAcNoDebtor")).sendKeys(Double.toString(account));
        return this;
    }
    ...
    public ClientToClient insertAgentInstructions(String intruct) {
        ...
        public ClientToClient insertParticulars(){
            try {
                Thread.sleep(1000);
                ...
                getWebElement(particularsClientToClient).sendKeys();
                return this;
            } catch (InterruptedException e) {
                throw new RuntimeException(e);
            }
        ...
        public ClientToClient insertCustomerAccountNo(String particulars){
            try {
                Thread.sleep(1000);
        ...
        public ClientToClient insertCustomerAccountName(String particulars){
            try {
                Thread.sleep(1000);
                By particularsClientToClient = By.id("contPlcHdrMasterHolder_TFtxtCustomerNameCreditor");
                Actions actions = new Actions(driver);
                actions.moveToElement(getWebElement(particularsClientToClient)).perform();
                getWebElement(particularsClientToClient).sendKeys(particulars);
                return this;
        ...
        public ClientToClient insertCustomerAddressLine(String particulars){
            try {
                Thread.sleep(1000);
        ...
        public ClientToClient selectCit2y(int index) {
